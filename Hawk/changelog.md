...
- Created Get-HawkTenantSigningKeyOperation, providing the ability to collect Graph Activity Logs for Entra ID Key signing operations to include rotation, creation, and invalidation events.
